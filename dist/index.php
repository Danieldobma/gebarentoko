...
<header>
          ...
          <div class="flex flex-1 items-center justify-center md:justify-between">
            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4">
                ...
                <a href="aanbod.php" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-3xl font-medium">Aanbod</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <main>
    <section class="hero">
      <div class="mx-auto my-20 max-w-7xl sm:px-6 lg:px-8">
        <div class="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
          <div class="absolute inset-0">
            <img class="h-full w-full object-cover" src="../src/img/pexels-monstera-5063095.jpg" alt="People working on laptops">
            <div class="absolute inset-0 bg-primary mix-blend-multiply"></div>
          </div>
          <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
            <h1 class="text-center text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              <span class="block text-white">Hoi allemaal!</span>
              <span class="block text-indigo-200">Welkom bij de Gebaren Toko.</span>
            </h1>
            <p class="mx-auto mt-6 max-w-lg text-center text-xl text-white sm:max-w-3xl">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
            <div class="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
              <div class="space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0">
                <a href="about.php" class="flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-3 text-base font-medium text-primary shadow-sm hover:bg-indigo-50 sm:px-8 text-xl">Lees meer</a>
                <a href="news.php" class="flex items-center justify-center rounded-md border border-transparent bg-primary bg-opacity-60 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-opacity-70 sm:px-8 text-xl">Naar nieuws</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="lg:grid lg:grid-cols-12">
            ...
            <div class="relative bg-secondary lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
              ...
              <div class="relative mx-auto max-w-md space-y-6 py-12 px-4 sm:max-w-3xl sm:py-16 sm:px-6 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
                <h2 class="text-3xl font-bold tracking-tight text-white" id="join-heading">Over mij</h2>
                ...
                <a class="block w-full rounded-md border border-transparent bg-white py-3 px-5 text-center text-base font-medium text-primary shadow-md hover:bg-gray-50 sm:inline-block sm:w-auto" href="#">Meer info</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="relative px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
        ...
        <div class="relative mx-auto max-w-7xl">
          <div class="text-center">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Gebaren from the blog</h2>
          ...
          <div class="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-3">
            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
              <div class="flex-shrink-0">
                <img class="h-48 w-full object-cover" src="../src/img/pexels-rosemary-ketchum-1464196.jpg" alt="">
              </div>
              <div class="flex flex-1 flex-col justify-between bg-white p-6">
                <div class="flex-1">
                  <p class="text-sm font-medium text-primary">
                    <a href="#" class="hover:underline">Nieuws</a>
                  </p>
            ...
            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
              <div class="flex-shrink-0">
                <img class="h-48 w-full object-cover" src="../src/img/pexels-sebastian-coman-photography-3522790.jpg" alt="">
              </div>
              <div class="flex flex-1 flex-col justify-between bg-white p-6">
                <div class="flex-1">
                  <p class="text-sm font-medium text-primary">
                    <a href="#" class="hover:underline">Activiteit</a>
                  </p>
                  <a href="#" class="mt-2 block">
                    <p class="text-xl font-semibold text-gray-900">Improve your customer experience</p>
                    <p class="mt-3 text-base text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint harum rerum voluptatem quo recusandae magni placeat saepe molestiae, sed excepturi cumque corporis perferendis hic.</p>
            ...
            <div class="flex flex-col overflow-hidden rounded-lg shadow-lg">
              <div class="flex-shrink-0">
                <img class="h-48 w-full object-cover" src="../src/img/pexels-rodnae-productions-7551438.jpg" alt="">
              </div>
              <div class="flex flex-1 flex-col justify-between bg-white p-6">
                <div class="flex-1">
                  <p class="text-sm font-medium text-primary">
                    <a href="#" class="hover:underline">Workshop</a>
                  </p>
                  <a href="#" class="mt-2 block">
                    <p class="text-xl font-semibold text-gray-900">Improve your customer experience</p>
                    <p class="mt-3 text-base text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint harum rerum voluptatem quo recusandae magni placeat saepe molestiae, sed excepturi cumque corporis perferendis hic.</p>
        ...
        <a href="aanbod.php" class="bg-primary flex items-center justify-center rounded-md border border-transparent bg-primary px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-opacity-70 sm:px-8 text-xl md:w-48 mx-auto mt-6" href="">Meer aanbod</a>
      </div>

    </section>

    <section class="koken max-w-7xl mx-auto">
     <div class="grid grid-cols-1 md:grid-cols-2 bg-neutral rounded-md my-16">
        <div class="col-span-1 pl-6 py-6 my-auto">
          <h1 class="text-3xl font-bold text-black">
            Edith Kookt Met Gebaren
          </h1>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Non omnis vitae similique distinctio ratione est velit nam magni quos deserunt repellendus minima facere officia dignissimos, officiis consequuntur ex inventore accusantium.
          </p>
          <a class="text-white" href="https://www.youtube.com/@edithkooktmetgebaren2300">Ga naar YouTube pagina of druk op de button</a>
        </div>
        <div class="col-span-1">
          <iframe class="w-full md:rounded-r-md" width="560" height="315" src="https://www.youtube.com/embed/Crs_mDesVE4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
     </div>
    </section>
  </main>
